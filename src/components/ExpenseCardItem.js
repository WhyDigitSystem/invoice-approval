    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={descriptionStyle}>
          <p style={{ ...descriptionItemStyle, fontSize: '15px', color: '#fff' }}>Code: {expense.empCode}</p>
          <p style={{ ...descriptionItemStyle, fontSize: '15px', color: '#fff' }}>Employee: {expense.empName}</p>
          <p style={{ ...descriptionItemStyle, fontSize: '15px', color: '#fff' }}>Exp Amt: {expense.totamt}</p>
        </div>
      </div>

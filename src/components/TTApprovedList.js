...
import { getTTInvDetailsApprove1 } from "../services/api"; // mock API call
...
const TTApprovedList = () => {
  ...
  const Listing = () => {
    navigate("/TTListing"); // Navigate to the approved list page
  };

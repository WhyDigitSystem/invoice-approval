...
export const PartyLedger = () => {
  ...
  const reportColumns = [
    ...
    { accessorKey: 'particulars', header: 'Particulars', size: 400  },
    { accessorKey: 'opbal', header: 'Op Bal.', size: 140 },
    { accessorKey: 'dbAmount', header: 'Db Amt', size: 140, cell: (info) => info.getValue(), className: 'align-right' },
    { accessorKey: 'crAmount', header: 'Cr Amt', size: 140 },
    { accessorKey: 'billDbAmount', header: 'Bill Db Amt', size: 140, cell: (info) => info.getValue(), className: 'align-right' },
    { accessorKey: 'billCrAmount', header: 'Bill Cr Amt', size: 140, cell: (info) => info.getValue(), className: 'align-right' },
    { accessorKey: 'suppRefNo', header: 'Supp Ref No', size: 140 },
    { accessorKey: 'suppRefDate', header: 'Supp Ref Date', size: 140 },
  ];
  ...
  const fetchData = () => {
    ...
    getPartyLedger(pbranchname,  selectedParty,formattedFromDate,formattedToDate,ptype,div)
      .then((response) => {
  ...
  return (
    <div className="card w-full p-6 bg-base-100 shadow-xl " style={{ padding: '20px', borderRadius: '10px',height: '100%', }}>
      ...
      <div className="row d-flex ml" style={{ marginTop: '40px' }}>
        ...
        <b><p style={{align:'left', marginLeft:'-900px'}}>Party Ledger <img src={rewindbutton} alt="Go back" style={{width:"30px", marginLeft:"60px",cursor: 'pointer'  }} onClick={handleImageClick}/> </p></b>   <br/> 
      ...
      <div className="input-data">
        ...
        > 
          {party.length > 0 ? (
            party.map((partyItem) => (
              <MenuItem key={partyItem.subledgerName} value={partyItem.subledgerName}>

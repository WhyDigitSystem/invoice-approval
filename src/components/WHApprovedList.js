...
import { getWHInvDetailsApprove1 } from "../services/api"; // mock API call
...
const WHApprovedList = () => {
  ...
  const Listing = () => {
    navigate("/WHListing"); // Navigate to the approved list page
  };

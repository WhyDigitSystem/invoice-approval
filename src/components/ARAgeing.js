...
export const ARAgeing = () => {
  ...
  const fetchData = () => {
    ...
    getARAgeing(formattedAsondt,div,pbranchname, ptype, subledgerName,slab1,slab2,slab3,slab4,slab5,slab6,slab7)
      .then((response) => {
  ...
  return (
    <div className="card w-full p-6 bg-base-100 shadow-xl " style={{ padding: '20px', borderRadius: '10px',height: '100%', }}>
      ...
      <div className="row d-flex ml" style={{ marginTop: '40px' }}>
        ...
        <b><p style={{align:'left', marginLeft:'-1000px'}}>AR Ageing <img src={rewindbutton} alt="Go back" style={{width:"30px", marginLeft:"60px",cursor: 'pointer'  }} onClick={handleImageClick}/> </p></b>   <br/> 
